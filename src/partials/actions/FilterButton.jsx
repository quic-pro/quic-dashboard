...
function FilterButton() {
  ...
  return (
    <div className="relative inline-flex">
      <button
        ref={trigger}
        className="btn bg-companyL dark:bg-companyD text-companyL-400 dark:text-companyD-400 hover:bg-companyL-200 dark:hover:bg-companyD-200 shadow-lg shadow-gray-400/30"
        aria-haspopup="true"
        onClick={() => setDropdownOpen(!dropdownOpen)}
        aria-expanded={dropdownOpen}
      >
        <span className="sr-only">Filter</span><wbr />
        <svg className="w-4 h-4 fill-companyL-400 opacity-80" viewBox="0 0 16 16">
      ...
      >
        <div ref={dropdown}>
          ...
          <div className="py-2 px-3 border-t border-slate-200 bg-companyL dark:bg-companyD">
            <ul className="flex items-center justify-between">
              ...
              <li>
                <button className="btn-xs opacity-80 hover:opacity-100 bg-companyL border-slate-200 dark:bg-companyD text-companyL-400 dark:text-companyD-400 hover:bg-companyL-200 dark:hover:bg-companyD-200" onClick={() => setDropdownOpen(false)} onBlur={() => setDropdownOpen(false)}>Apply</button>
              </li>
            </ul>
          </div>
        </div>
