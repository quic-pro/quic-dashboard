    ...
    return (
        <div className="relative inline-flex ml-3">
            ...
            >
                ...
                <div
                    className="absolute top-0 right-0 w-2.5 h-2.5 bg-rose-500 border-2 border-white rounded-full"></div>
            </button>
            ...
            >
                ...
                >
                    <div
                        className="text-xs font-semibold text-companyL-400 dark:text-companyL-400 uppercase pt-1.5 pb-2 px-4">Notifications
                    </div>
                    <ul>
                        <li className="border-b border-slate-200 last:border-0">
                            ...
                            >
                                <span className="block text-sm mb-2">📣 <span
                                    className="font-medium text-companyBottomL dark:text-companyBottomL">Edit your information in a swipe</span> Sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim.</span>
                        ...
                        <li className="border-b border-slate-200 last:border-0">
                            ...
                            >
                                <span className="block text-sm mb-2">📣 <span
                                    className="font-medium companyBottomL dark:text-companyBottomL">Edit your information in a swipe</span> Sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim.</span>
