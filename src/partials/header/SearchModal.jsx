                ...
                <div ref={modalContent}
                    ...
                    <div className="py-4 px-2">
                        ...
                        <div className="mb-3 last:mb-0">
                            <div className="text-xs font-semibold text-companyL-400 uppercase px-2 mb-2">Recent
                                searches
                            </div>
                            <ul className="text-sm">
                                <li>
                                    ...
                                    >
                                        <svg className="w-4 h-4 fill-current text-companyL-400 shrink-0 mr-3"
                                            viewBox="0 0 16 16">
                                            <path
                        ...
                        {/* Recent pages */}
                        <div className="mb-3 last:mb-0">
                            <div className="text-xs font-semibold text-companyL-400 uppercase px-2 mb-2">Recent pages
                            </div>
                            <ul className="text-sm">
                                <li>
                                    <Link
